    ...
    <div className="space-y-6">
      ...
      {canSellByPackage && (
        <div className="space-y-4">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-lg font-semibold text-gray-700">Precio Especial por Paquete:</span>
          ...
          {allSizesHavePreorderStock && (
            <div className="flex flex-col items-center gap-4">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-lg font-semibold text-gray-700">Precio Especial en paquete Preventa:</span>
